...
def resumo(valor,porcento1,porcento2):
    ...
    print('80% de aumento: R${}'.format(moeda(aumento(valor,porcento1),sit=True), flush = True))
    print('35% de redução: R${}'.format(moeda(redução(valor,porcento2),sit=True),flush = True))
    print('-------------------------------------------------')
